...
class MulticastDtoMapper extends ClassMapperBase<MulticastDto> {
  ...
  static String? _$codeHash(MulticastDto v) => v.codeHash;
  static const Field<MulticastDto, String> _f$codeHash = Field(
    'codeHash',
    _$codeHash,
    opt: true,
  );
  static String? _$cliSessionId(MulticastDto v) => v.cliSessionId;
  static const Field<MulticastDto, String> _f$cliSessionId = Field(
    'cliSessionId',
    _$cliSessionId,
    opt: true,
  );
  static bool? _$cliMode(MulticastDto v) => v.cliMode;
  static const Field<MulticastDto, bool> _f$cliMode = Field(
    'cliMode',
    _$cliMode,
    opt: true,
  );
  ...
  static MulticastDto _instantiate(DecodingData data) {
    return MulticastDto(
      ...
      cliSessionId: data.dec(_f$cliSessionId),
      cliMode: data.dec(_f$cliMode),
    );
  }
...
class _MulticastDtoCopyWithImpl<$R, $Out>
  ...
  $R call({
    ...
    Object? codeHash = $none,
    Object? cliSessionId = $none,
    Object? cliMode = $none,
  }) => $apply(
    FieldCopyWithData({
      ...
      if (codeHash != $none) #codeHash: codeHash,
      if (cliSessionId != $none) #cliSessionId: cliSessionId,
      if (cliMode != $none) #cliMode: cliMode,
    }),
  );
  @override
  MulticastDto $make(CopyWithData data) => MulticastDto(
    ...
    cliSessionId: data.get(#cliSessionId, or: $value.cliSessionId),
    cliMode: data.get(#cliMode, or: $value.cliMode),
  );
